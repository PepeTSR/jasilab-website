...
export const trustRoadmapPhases: RoadmapPhase[] = [
 ...
 { label: "Screening check", done: true, href: cvtPath("concepts/soft-search") },
 { label: "Consented review", done: true, href: cvtPath("concepts/enhanced-search") },
 { label: "Restricted disclosure (contracted)", done: true, href: cvtPath("concepts/hard-search") },
 { label: "Partner portal and APIs", done: true, href: cvtPath("partners") },
...
export const liveTodayItems = [
 ...
 {
 title: "Trust Passport & partner access",
 body: "Public trust passports, consent-gated partner lookups under agreement, and a partner portal on cvt.ug.",
 },
 {
 ...
 {
 title: "Complaint capture & review",
 body: "Reports against vehicles are captured and reviewed by staff before standing can be affected.",
 },
 {
...
export function getSiteLayers() {
  return [
    ...
    { label: "Platform", href: cvtPath("platform"), desc: "Products on the trust layer" },
    { label: "Project map", href: cvtPath("map"), desc: "How the pieces connect" },
    { label: "Roadmap", href: cvtPath("roadmap"), desc: "Where CVT goes next" },
  ];
}
