...
export const productLinks = [
 ...
 tagline:
 "WhatsApp tourism assistant - packages, offers, and guest support for Zazu Africa Safaris.",
 },
...
export const cvtConcepts = [
 { slug: "trust-profile", title: "Trust Profile", summary: "Your current standing and highlights, built from verified facts." },
 { slug: "trust-timeline", title: "Trust Timeline", summary: "Verified history that does not change silently." },
 { slug: "trust-level", title: "Trust Level", summary: "Bronze through Platinum - standing that grows with verified positive signals." },
 { slug: "trust-passport", title: "Trust Passport", summary: "Portable standing you can share with partners under consent." },
 { slug: "good-standing", title: "Good Standing", summary: "A clear status based on verified record, cover and tenure." },
 { slug: "stage-b-moderation", title: "Fair complaints", summary: "Complaints are reviewed before they can affect standing - rumours do not." },
 { slug: "soft-search", title: "Screening check", summary: "Summary standing for early screening - no conduct narrative." },
 { slug: "enhanced-search", title: "Consented review", summary: "Richer detail when someone grants purpose-specific consent." },
 { slug: "hard-search", title: "Restricted disclosure", summary: "Limited legal access - contract, approval and audit only." },
] as const;
...
export function getCvtExploreLinks() {
 ...
 return [
      ...
      { href: cvtPath("platform"), label: "Platform", desc: "Products on the trust layer" },
    ];
  }
  ...
  return [
    ...
    { href: cvtPath("roadmap"), label: "Roadmap", desc: "Where CVT goes next" },
